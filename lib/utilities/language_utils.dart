...
/// Returns the device's system language code if the app supports it,
/// otherwise falls back to English. Used only to pick the default
/// language on first launch, before the user has chosen one explicitly.
String detectSystemLanguageCode() {
  final systemLanguageCode = PlatformDispatcher.instance.locale.languageCode;
  return appLanguages.contains(systemLanguageCode) ? systemLanguageCode : 'en';
}
