...
class _PlaylistPageState extends State<PlaylistPage> {
  ...
  Future<void> _initializePlaylist() async {
    try {
      ...
      if (_playlist != null && _playlist['list'] != null) {
        ...
        _sortPlaylist(_sortType, _sortAscending);
    ...
    return IconButton.filledTonal(
      ...
      onPressed: () async {
        try {
          ...
          final url = 'dskplay://playlist/custom/$encodedPlaylist';
  ...
  void _sortPlaylist(PlaylistSortType type, bool ascending) {
    ...
    switch (type) {
      ...
      case PlaylistSortType.title:
        ...
        sortSongsByKey(playlist, 'title', ascending: ascending);
        _playlist['list'] = playlist;
        break;
      case PlaylistSortType.artist:
        final playlist = List<dynamic>.from(_playlist['list']);
        sortSongsByKey(playlist, 'artist', ascending: ascending);
        _playlist['list'] = playlist;
        break;
      case PlaylistSortType.dateAdded:
        // Original list order is oldest-first; ascending here means the
        // established default (newest first).
        _playlist['list'] = ascending
            ? List<dynamic>.from(_originalPlaylistList.reversed)
            : List<dynamic>.from(_originalPlaylistList);
        break;
    }
  }
