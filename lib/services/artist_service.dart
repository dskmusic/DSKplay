...
// Only dedupes by channel id. Two distinct channels can legitimately share
// the exact same artist name (e.g. an old and a new upload channel), so
// deduping by name as well would silently drop one of them from results.
