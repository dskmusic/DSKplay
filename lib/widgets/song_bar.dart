...
import 'package:musify/services/song_export_service.dart';
...
Future<void> _shareSongFlow(
  ...
  if (choice == 'link') {
    await SharePlus.instance.share(
      ShareParams(text: 'https://youtube.com/watch?v=$ytid', subject: title),
    );
    return;
  }
      ...
      builder: (context) => AlertDialog(
        content: Row(
          ...
          children: [
            ...
            Text(context.l10n!.preparingShare),
          ],
        ),
      ),
    ),
